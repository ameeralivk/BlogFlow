...
export class PostController implements IPostController {
  ...
  updatePost = async (req: Request, res: Response): Promise<Response> => {
    ...
    const post = assertFound(await this._postService.updatePost(id as string, updateData), "Post not found");
  ...
  getPostById = async (req: Request, res: Response): Promise<Response> => {
    const { id } = req.params;
    const post = assertFound(await this._postService.getPostById(id as string), "Post not found");
